...
**Checked 2026-09-17** against the official page, https://nansen.ai/campaigns/meridian-buildathon.
...
Dates: 14 to 27 September 2026. Judging is 25% each: data integration, creativity and originality,
functionality and workability, and documentation and submission.
...
| X Post Demo | the link to the post above |
| Github Repo | https://github.com/MicroQuack/dejaview |

After posting, put the post link in the README "Demo" section.
